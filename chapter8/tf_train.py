...
if __name__ =='__main__':
    ...
    def serving_input_fn():
        ...
        return tf.estimator.export.build_parsing_serving_input_receiver_fn({'input': tensor})()

    tf_regressor.export_savedmodel(export_dir_base = args.local_model_dir + '/export/Servo', serving_input_receiver_fn = serving_input_fn)